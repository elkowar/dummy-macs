;; doom-betterbox-theme.el --- inspired by morhetz Gruvbox -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup doom-betterbox-theme nil
  "Options for doom-betterbox."
  :group 'doom-themes)

(defcustom doom-betterbox-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-betterbox-theme
  :type 'boolean)

(defcustom doom-betterbox-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-betterbox-theme
  :type '(choice integer boolean))

(defcustom doom-betterbox-dark-variant nil
...
;;
(def-doom-theme doom-betterbox 
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-betterbox-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-betterbox-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                          '("#282828" "#282828" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-betterbox-dark-variant "hard") '("#282828" "#282828" nil))
          ((equal doom-betterbox-dark-variant "soft") '("#403d3d" "#404040" nil))
          (t                                          '("#282828" "#282828" nil))))
   ...
   ;; Standardized official colours from betterbox
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-betterbox-brighter-comments magenta grey))
   (doc-comments   (if doom-betterbox-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      cyan)
   (keywords       red)
   (methods        cyan)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-betterbox-padded-modeline
      (if (integerp doom-betterbox-padded-modeline)
          doom-betterbox-padded-modeline
        4)))
  ...
  (
   ...
   (mode-line-inactive
    :background "#1d2021" :foreground base4
...
;;; doom-betterbox-theme.el ends here
